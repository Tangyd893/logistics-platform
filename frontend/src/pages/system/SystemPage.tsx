...
export default function SystemPage() {
  ...
  const columns = [
    ...
    { key: 'roleCode', label: '角色', width: '110px', render: (row: SysUser) => <span style={{ fontSize: '0.8rem', padding: '0.125rem 0.5rem', backgroundColor: '#f1f5f9', borderRadius: '0.25rem' }}>{roleLabels[row.roleCode] || row.roleCode}</span> },
